...
const Footer = () => {
  return (
    <footer className="fixed bottom-0 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-md pointer-events-none">
      <div className="bg-black/90 backdrop-blur-md border-t border-white/10 w-full rounded-t-xl overflow-hidden hover:pb-4 transition-all duration-300 pointer-events-auto group">
        ...
        <div className="max-h-0 opacity-0 group-hover:max-h-16 group-hover:opacity-100 transition-all duration-300 ease-in-out overflow-hidden">
          <div className="flex flex-row items-center justify-center gap-8 pb-3">
            <a
              href="mailto:zack.chen@uwaterloo.ca"
              className="inline-flex items-center gap-2 font-body text-gray-400 hover:text-blue-400 hover:underline underline-offset-4 transition-colors"
            >
