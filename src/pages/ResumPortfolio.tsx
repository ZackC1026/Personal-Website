                ...
                <section className="w-full md:w-1/2 overflow-y-auto p-6 md:p-8 flex flex-col bg-gray-50/50 min-h-[calc(100vh-64px)] md:min-h-0">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                        <ProjectCard
                            ...
                            date="2025"
                            image="https://images.unsplash.com/photo-1616469829941-c7200edec809?q=80&w=2670&auto=format&fit=crop" // PCB placeholder
                        ...
                        <ProjectCard
                            ...
                            date="2026"
                            image="https://images.unsplash.com/photo-1622435869300-8805f77878c7?q=80&w=2671&auto=format&fit=crop" // Battery placeholder
                        ...
                        <ProjectCard
                            ...
                            date="2025"
                            image="https://images.unsplash.com/photo-1555664424-778a69022365?q=80&w=2670&auto=format&fit=crop" // Electronics placeholder
                        ...
                        <ProjectCard
                            ...
                            date="2026"
                            image="https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?q=80&w=2670&auto=format&fit=crop" // Plant/Sensor placeholder
                        ...
                        <ProjectCard
                            title="Heartbeat PCB"
                            date="2026"
                            image="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?q=80&w=2670&auto=format&fit=crop" // Medical/Heart placeholder
                        ...
                        <ProjectCard
                            ...
                            date="2025"
                            image="https://images.unsplash.com/photo-1509391366360-2e959784a276?q=80&w=2672&auto=format&fit=crop" // Solar placeholder
                        ...
                        <ProjectCard
                            ...
                            date="2025"
                            image="https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=1470&auto=format&fit=crop" // Tech card placeholder
                        ...
                        <ProjectCard
                            ...
                            date="2025"
                            image="https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=2670&auto=format&fit=crop" // Chip placeholder
